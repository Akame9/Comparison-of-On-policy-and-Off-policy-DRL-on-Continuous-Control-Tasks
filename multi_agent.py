...
def main():
    ...
    if args.mode == 'train':
        agent1.load_model("results/ddpg_agent1_soccer_model_60_33.pth")
        soccer_train_ddpg_vs_ddpg(env, agent1, agent2, num_episodes=args.episodes)
        
    elif args.mode == 'test':
        agent1_ckpt = agent1.load_model("results/a2c_agent1_soccer_model_20_1.pth")
        agent2_ckpt = agent2.load_model("results/ddpg_agent2_soccer_model_20_1.pth")
        video_filename = 'videos/ddpg_vs_a2c_evaluation_soccer_20.mp4' 
